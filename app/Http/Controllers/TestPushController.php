...
class TestPushController extends Controller
{
  public function send(Request $r)
  {
    ...
    foreach ($tokens as $token) {
      logger($token);
      Fcm::send($token, "Prueba notificación", "¡Hola! Esta es una prueba de notificación push", ['link' => 'https://mindmeet.com.mx', 'icon' => 'https://mindmeet.com.mx/favicon/android-chrome-192x192.png']);
    }
