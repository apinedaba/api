...
class Patient extends Authenticatable
{
    ...
    protected $fillable = ['organization_id', 'registration_source', 'name', 'email', 'phone', 'password', 'address', 'contacto', 'historial', 'activo', 'status', 'historiaClinica', 'consentimiento', 'relevantes', 'personales', 'relationships', 'image', 'credential_public_id'];
