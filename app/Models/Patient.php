...
class Patient extends Authenticatable
{
    ...
    protected $fillable = ['organization_id', 'registration_source', 'name', 'email', 'provider_name', 'provider_id', 'avatar', 'phone', 'password', 'address', 'contacto', 'historial', 'activo', 'status', 'historiaClinica', 'consentimiento', 'relevantes', 'personales', 'relationships', 'image', 'credential_public_id'];
