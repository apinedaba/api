                        ...
                        <table className="min-w-full divide-y divide-gray-200 text-sm">
                            <thead className="bg-gray-50 text-left">
                                <tr>
                                    ...
                                    <th className="px-4 py-3 font-semibold text-gray-600">Acceso</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-gray-100">
                                {referrals.map((ref) => (
                                    <tr key={ref.id} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="px-4 py-3">
                                            {ref.psychologist?.login_url ? (
                                                <a
                                                    href={ref.psychologist.login_url}
                                                    target="_blank"
                                                    rel="noreferrer"
                                                    className="inline-flex whitespace-nowrap rounded-md border border-sky-200 px-3 py-2 text-xs font-bold text-sky-700 transition hover:bg-sky-50"
                                                >
                                                    Abrir login
                                                </a>
                                            ) : '—'}
