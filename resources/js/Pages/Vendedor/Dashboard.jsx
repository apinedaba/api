...
function CopyLoginLinkButton({ url }) {
    ...
    return (
        <button
            type="button"
            onClick={copyLink}
            className={`whitespace-nowrap rounded-md border px-3 py-2 text-xs font-bold transition ${copied
                                    ...
                                    <tr key={ref.id} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="px-4 py-3">
                                            {ref.psychologist?.login_url ? (
                                                <CopyLoginLinkButton url={ref.psychologist.login_url} />
                                            ) : '—'}
                                        </td>
                                    </tr>
                                ))}
