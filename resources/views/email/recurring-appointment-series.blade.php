    ...
    <table cellpadding="0" cellspacing="0" width="100%" style="background:#f8fafc; border:1px solid #e2e8f0; border-radius:8px; margin:0 0 24px;">
        <tr>
            <td style="padding:18px;">
                <p style="font-size:14px; color:#334155; margin:0 0 8px;"><strong>Primera sesion:</strong> {{ $firstSession }}</p>
                <p style="font-size:14px; color:#334155; margin:0 0 8px;"><strong>Vigencia hasta:</strong> {{ $until }}</p>
                <p style="font-size:14px; color:#334155; margin:0;"><strong>Total de sesiones generadas:</strong> {{ $occurrencesCount }}</p>
            </td>
        </tr>
    </table>
