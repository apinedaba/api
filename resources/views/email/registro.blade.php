                                            ...
                                            <tr>
                                                <td class="column column-1" width="100%"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center" style="padding: 10px;">
                                                                <div
                                                                    style="background-color: #f2f2f2; border-radius: 8px; padding: 15px 20px; display: inline-block;">
                                                                    <h2
                                                                        style="margin: 0; color: #00529B; font-family: Arial, sans-serif; font-size: 32px; font-weight: 700; letter-spacing: 4px; line-height: 120%;">
                                                    ...
                                                    <p style="margin: 0; margin-top: 16px;">
                                                        Este código expirará en 10 minutos. Si no solicitaste este
                                                        registro, puedes ignorar este mensaje.
                                                    </p>
