                                                            ...
                                                            <td class="pad" style="width:100%;">
                                                                <div class="alignment" align="center"
                                                                    ...
                                                                    <div style="max-width: 125px;"><img
                                                                            ...
                                                                            width="125" alt title height="auto">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
...
<![endif]--><span class="button" style="background-color: #00c3b7; border-bottom: 0px solid transparent; border-left: 0px solid transparent; border-radius: 4px; border-right: 0px solid transparent; border-top: 0px solid transparent; color: #ffffff; display: inline-block; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 16px; font-weight: 400; mso-border-alt: none; padding-bottom: 5px; padding-top: 5px; padding-left: 20px; padding-right: 20px; text-align: center; width: auto; word-break: keep-all; letter-spacing: normal;"><span
                                                                            style="word-break: break-word; line-height: 32px;">WhatsApp</span></span><!--[if mso]></center></v:textbox></v:roundrect><![endif]-->
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                            ...
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; margin-bottom: 16px;">Gracias
                                                                        ...
                                                                        Estamos felices de tenerte con nosotros.</p>
                                                                    <p style="margin: 0;">&nbsp;Es necesario que
                                                                        confirmes tu correo electrónico para poder
                                                                        comenzar a usar la plataforma, es muy sencillo,
                                                                        solo da clic en el enlace de abajo</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
...
<![endif]--><span class="button" style="background-color: #00c3b7; border-bottom: 0px solid transparent; border-left: 0px solid transparent; border-radius: 4px; border-right: 0px solid transparent; border-top: 0px solid transparent; color: #ffffff; display: inline-block; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; font-weight: 400; mso-border-alt: none; padding-bottom: 5px; padding-top: 5px; padding-left: 20px; padding-right: 20px; text-align: center; width: auto; word-break: keep-all; letter-spacing: normal;"><a
                                                                    ...
                                                                    </span><!--[if mso]></center></v:textbox></v:roundrect><![endif]-->
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
